export const SEO_CONFIG = {
  ...
  defaultDescription: 'Crie seu site profissional por apenas R$90/mês ou compre por R$2.500 únicos. Hospedagem, manutenção e suporte inclusos. Mais de 200 sites criados com sucesso.',
  ...
  company: {
    ...
    phone: '+55 11 98765-4321', // Substitua pelo seu telefone
    address: {
...
export const PAGE_SEO = {
  home: {
    ...
    description: 'Crie seu site profissional com a Pixelaria. Assinatura mensal R$90 ou compra única R$2.500. Hospedagem, segurança e manutenção inclusos. Mais de 200 sites criados.',
    canonical: '/',
    keywords: [
      'criação de sites',
      'sites profissionais',
