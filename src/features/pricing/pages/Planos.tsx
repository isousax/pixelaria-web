...
import { Check, X, Star, DollarSign, Calendar, Calculator, MessageCircle, ChevronDown, Sparkles, Shield, Zap, Award, Quote } from 'lucide-react';
...
import { formatCurrency, createWhatsAppLink, whatsAppMessages } from '../../../shared/utils/helpers';
...
const planFaqs = [
  {
    ...
    answer: 'Na Assinatura Mensal você paga R$ 90/mês e tem hospedagem, manutenção e suporte incluídos. Na Compra Única você paga R$ 4.500 uma vez e recebe o código-fonte, mas precisa contratar hospedagem separadamente.',
  },
  {
...
export const Planos = () => {
  ...
  return (
    <>
      <SEO
        title={PAGE_SEO.planos.title}
        description={PAGE_SEO.planos.description}
        canonical={PAGE_SEO.planos.canonical}
        keywords={PAGE_SEO.planos.keywords}
      ...
      <div className="bg-neutral-50 overflow-x-hidden">
        ...
        <div className="container-custom py-16">
          ...
          {/* Pricing Cards */}
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 max-w-6xl mx-auto mb-12 px-4">
            {pricingPlans.map((plan, index) => (
              ...
              >
                <Card
                  ...
                  padding="none"
                  className={`h-full overflow-hidden ${plan.popular ? 'ring-2 ring-primary-600 shadow-xl lg:shadow-2xl lg:scale-105' : ''}`}
                >
                  {plan.popular && (
                    <div className="bg-gradient-to-r from-primary-600 to-secondary-600  text-center py-2 sm:py-3 font-bold text-xs sm:text-base">
                      <Star className="w-3 h-3 sm:w-5 sm:h-5 inline-block mr-1 sm:mr-2" />
                      <span className="text-xs sm:text-base">PLANO MAIS POPULAR</span>
                    </div>
                  )}

                  <div className="p-5 sm:p-6 lg:p-8">
                    <h3 className="text-2xl sm:text-3xl font-black mb-2 text-neutral-900">{plan.name}</h3>
                    <div className="mb-4 sm:mb-6">
                      <div className="flex items-baseline gap-1 sm:gap-2">
                        ...
                        {plan.type === 'subscription' && (
                          <span className="text-lg sm:text-2xl text-neutral-600">/mês</span>
                        )}
                      </div>
                      {plan.type === 'subscription' ? (
                        <p className="text-sm sm:text-base text-neutral-600 mt-2">Sem fidelidade • Cancele quando quiser</p>
                      ) : (
                        <p className="text-sm sm:text-base text-neutral-600 mt-2">Pagamento único • Código-fonte seu</p>
                      )}
                    </div>
                    ...
                    <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                      {plan.features.map((feature, idx) => (
                        <li key={idx} className="flex items-start gap-2 sm:gap-3">
                          ...
                          <span className="text-sm sm:text-base text-neutral-700 leading-relaxed">{feature}</span>
                        </li>
                      ))}
                    </ul>
          ...
          {/* Comparison Toggle */}
          <div className="text-center mb-12 sm:mb-8 sm:py-12">
            <Button
              variant="outline"
              size="lg"
          ...
          <section className="mb-16">
            <Card padding="sm">
              ...
              >
                ...
                <h2 className="text-3xl sm:text-4xl font-black mb-4">Calculadora de ROI</h2>
                <p className="text-xl">
                  ...
                  <Card variant="elevated" padding="sm">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-xl font-bold text-primary-600">{formatCurrency(subscriptionTotal)}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-neutral-600">Receita estimada:</span>
                        <span className="text-xl font-bold text-green-600">{formatCurrency(roiRevenue * roiMonths)}</span>
                      </div>
                      <div className="pt-3 border-t border-neutral-200">
                        <div className="flex justify-between items-center">
                          <span className="font-bold text-neutral-900">ROI:</span>
                          <span className="text-2xl font-black text-green-600">+{roiPercentage.toFixed(0)}%</span>
                        </div>
                      </div>
                    </div>
                  </Card>
                  ...
                  <Card variant="elevated" padding="lg">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-xl font-bold text-secondary-600">{formatCurrency(oneTimeTotal)}</span>
                      </div>
                      ...
                      <div className="pt-3 border-t border-neutral-200">
                        <div className="flex justify-between items-center">
                          ...
                          <span className={`text-xl font-bold ${subscriptionTotal > oneTimeTotal ? 'text-green-600' : 'text-red-600'}`}>
